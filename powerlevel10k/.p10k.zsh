# Generated by Powerlevel10k configuration wizard on 2024-06-17 at 12:04 PST.
...
() {
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded (elflord Type green).
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#60ff60'
  # Red prompt symbol if the last command failed (elflord Special red).
  ...
  ##################################[ dir: current directory ]##################################
  # Default current directory color (elflord Comment blue).
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#80a0ff'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#80a0ff'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#80a0ff'
  ...
  # Icon color (elflord Type green).
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR='#60ff60'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=001
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='#60ff60'
